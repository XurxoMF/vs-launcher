        ...
        <Dialog static open={isOpen} onClose={close}>
          ...
          >
            <motion.div initial={{ scale: 0.5 }} animate={{ scale: 1 }} exit={{ scale: 0.5 }} transition={{ duration: 0.2 }}>
              <DialogPanel className={clsx("flex flex-col gap-4 text-center p-6 rounded-md border border-zinc-400/5 bg-zinc-950/30 shadow-sm shadow-zinc-950/25", maxWidth && "max-w-[600px]")}>
                <>
